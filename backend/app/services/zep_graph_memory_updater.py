...
class AgentActivity:
    ...
    def _describe_quote_post(self) -> str:
        ...
        if quote_content:
            base += f' and added: "{quote_content}"'
        return base
    ...
    def _describe_create_comment(self) -> str:
        ...
        if content:
            if post_content and post_author:
                return f'commented on a post by {post_author}: "{content}" (post: "{post_content}")'
            elif post_content:
                return f'commented on a post: "{content}" (post: "{post_content}")'
            elif post_author:
