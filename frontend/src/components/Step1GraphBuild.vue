    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the documents and simulation prompt, extracts the seed data, and generates the ontology automatically.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, the documents are chunked automatically and sent to Zep to build the knowledge graph, extract entities and relations, and form timeline memory and community summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The knowledge graph build is complete. Continue to environment setup.</p>
          <button 
            class="action-btn" 
